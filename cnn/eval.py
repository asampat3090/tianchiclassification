...
test_dir = os.path.abspath('/home/benze/dev/media/output32/test1/files/')
log_dir = os.path.abspath('/home/benze/dev/media/tianchiclassification/logs/20160410-191735/')
...
with graph.as_default():
	...
	eval_batch = test_container.data.shape[0]
	sess = tf.Session()
	...
	with sess.as_default():
		...
		matches = all_predictions.astype(int) == np.argmax(test_container.labels, 1)
